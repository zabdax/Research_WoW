...
def main() -> None:
    ...
    report = {
        ...
        "h2_geocentric_sensitivity": geocentric_offset_report(),
    }
    ...
    h2 = report["h2_geocentric_sensitivity"]
    lines += ["", "## H2 public ephemeris sensitivity", "", f"- Source solution: `{h2['object_solution']}`; epoch: `{h2['epoch_utc']}`; frame: `{h2['frame']}`.", f"- Geocentric angular offset to candidate A: **{h2['offsets_deg']['candidate_a']:.3f}°**.", f"- Geocentric angular offset to candidate B: **{h2['offsets_deg']['candidate_b']:.3f}°**.", f"- Restriction: {h2['interpretation']}"]
